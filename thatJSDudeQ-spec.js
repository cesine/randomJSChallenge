...
var allQ = require('./thatJSDudeQ');

describe('that JS Dude Question', function() {
	it('should reverse a sentense', function() {
...
describe('that JS Dude Question #10', function() {
	it('should reverse each word in a sentense', function() {
...
describe('that JS Dude Question #11', function() {
	it('should find the first duplicated Char', function() {
	...
	it('should find the first NON duplicated Char', function() {
		expect(allQ.Q11.giveMeFirstNonRepeatChar('the quick brown fox jumps then quickly blow air')).toEqual('f');
	});
});

describe('that JS Dude Question #15', function() {
	it('should Sort and find the missing number ', function() {
	...
	it('should loop and find the missing number', function() {
...
describe('that JS Dude Question #16', function() {
	it('should check if the dividor is inside the array ', function() {
	...
	it('Real Q16, Sum 2 in array to get result', function() {
...
describe('Question of 0', function() {
	it('should calculate proper 0', function() {
