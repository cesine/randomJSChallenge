...
var allQ = require('./someIntervQ');  //Easier in ES6 I can just require the function itself.

describe('Some test from GlassDoor on Addapa', function() {
	...
	it('Q1: should solve a Suduku box', function() {
	...
	it('shoudl return a array of unique number', function() {
		expect(allQ.Q.returnNumOfUniqueIntegers([1,2,2,2,2,3,3,3,4,5,4,5,6,7,2,10])).toMatch([1,6,7,10]);
	});

	it('should return a array of the max 2 number found.', function() {
	...
	it('Should return the missing 2 number of the Array', function() {
